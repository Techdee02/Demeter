        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[var(--color-bark)] mt-1">
              Detailed crop risk assessment and predictions
            </p>
          </div>
        </div>
        ...
        <Card className="hover-lift">
          ...
          <CardContent>
            <div className="text-center py-12">
              <Target className="w-16 h-16 text-[var(--color-terracotta)] mx-auto mb-4" />
              ...
              <p className="text-[var(--color-bark)] max-w-md mx-auto">
                This page will provide comprehensive risk analysis including stress predictions, 
                disease detection, weather impact assessment, and mitigation strategies.
              </p>
            </div>
          </CardContent>
        </Card>
